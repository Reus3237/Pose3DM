...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="checkpoint/pose3d/Pose3DM_L/config.yaml", help="Path to the config file.")
    parser.add_argument('-e', '--evaluate', default='checkpoint/pose3d/Pose3DM_L/best_epoch.bin', type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
