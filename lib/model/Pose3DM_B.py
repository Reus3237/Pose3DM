...
class Pose3DM(nn.Module):
    def __init__(self,
        ...
        for i in range(num_blocks[0]):
            block = Poseblock(num_frame=num_frame, num_joints=num_joints, in_chans=16*2,
                                    embed_dim_ratio=16*2, depth=depth, mlp_ratio=mlp_ratio,
        ...
        for i in range(num_blocks[1]):
            block = Poseblock(num_frame=num_frame, num_joints=num_joints, in_chans=32*2,
                                    embed_dim_ratio=32*2, depth=depth, mlp_ratio=mlp_ratio,
                                    drop_rate=drop_rate, drop_path_rate=drop_path_rate, norm_layer=norm_layer,
                              )
        ...
        for i in range(num_blocks[2]):
            block = Poseblock(num_frame=num_frame, num_joints=num_joints, in_chans=64*2,
                                    embed_dim_ratio=128*2, depth=depth, mlp_ratio=mlp_ratio,
                                    drop_rate=drop_rate, drop_path_rate=drop_path_rate, norm_layer=norm_layer,
                              )
        ...
        for i in range(num_blocks[2]):
            block = Poseblock(num_frame=num_frame, num_joints=num_joints, in_chans=128*2,
                                    embed_dim_ratio=64*2, depth=depth, mlp_ratio=mlp_ratio,
                                    drop_rate=drop_rate, drop_path_rate=drop_path_rate, norm_layer=norm_layer,
                              )
